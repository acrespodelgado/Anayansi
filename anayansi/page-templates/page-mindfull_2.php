		...
		<div class="container green" id="content">
			...
			<div class="row mt-6" id="formacionime">
				<div class="col-xl-7 col-lg-6 col-md-6">
					...
					Se desarrolla forma Online con opción a un Retiro presencial para Educadores Conscientes en contacto con la naturaleza.', 'understrap-master' ); ?></p>
			...
			*/ ?>			<?php /* -----------
						...
						*/ ?>
			<?php /*
						<li class="mb-3">• <?php _e( '5 Seminarios Online en directo acompañados por Expertos de Mindfulness a nivel internacional.', 'understrap-master' ); ?></li>
						<li class="mb-3">• <?php _e( 'Certificación profesional como Instructor/a de Mindfulness en Educación, emitido por Mindala Mindful Learning. Reconocido y homologado por la Consejería de Educación (Junta de Andalucía).', 'understrap-master' ); ?></li>
						...
						<li class="mb-3">• <?php _e( 'Acceso a un grupo privado exclusivo sobre Mindfulness Educativo, donde compartimos  recursos y experiencias de interés docente.', 'understrap-master' ); ?></li>
						...
						<li class="mb-3">• <?php _e( 'Opción de Retiro presencial o en streaming para Educadores Conscientes. (No incluido en el precio).', 'understrap-master' ); ?></li>
					</ul>
				</div>
			</div>			
			<div class="row mt-6">
		...
		<div class="container-fluid plant-background-3">
			<div class="row">
				<div class="container mt-6 green">
					<div class="row mt-6">
						<div class="col-md-7">
							<h4 class="bitter mb-4"><?php //_e( 'Sesiones de la Formación IME:', 'understrap-master' ); ?>
							<?php _e( 'Sesiones de la Formación:', 'understrap-master' ); ?></h4>
							<ul class="list-unstyled">
								<li class="mb-2">• <?php _e( '<strong>Seminario 1:</strong> Introducción al Mindfulness y la Autocompasión.', 'understrap-master' ); ?></li>
								<li class="mb-2">• <?php _e( '<strong>Seminario 2:</strong> Descubrir el Mindfulness en la Educación.', 'understrap-master' ); ?></li>
								<li class="mb-2">• <?php _e( '<strong>Seminario 3:</strong> La corporalidad y el movimiento consciente.', 'understrap-master' ); ?></li>
								<li class="mb-2">• <?php _e( '<strong>Seminario 4:</strong> Cultivar la Compasión y la autorregulación emocional.', 'understrap-master' ); ?></li>
								<li class="mb-2">• <?php _e( '<strong>Seminario 5:</strong> El educador/a consciente.', 'understrap-master' ); ?></li>
							</ul>
							...
							<a class="btn no-radius btn-primary big mt-4 mb-md-0 mb-4" href="<?php echo get_site_url();?>/contacto/"><?php _e( 'Más información', 'understrap-master' ); ?></a>
						</div>
					</div>		
				</div>
			</div>	
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-9 offset-lg-3 col-md-8 offset-md-4">
						<h4 class="brown-line  bitter mb-md-5 mb-0"><?php //_e( 'Directora de la Formación IME:', 'understrap-master' ); ?>
						<?php _e( 'Directora de la Formación:', 'understrap-master' ); ?></h4>
					</div>
				</div>
					...
					<div class="item">				
						<div class="row">
							...
							<div class="col-lg-9 col-md-8">
								...
								<h4 class="brown-line  bitter mb-md-5 my-5"><?php _e( 'Y su equipo de Expertos Profesionales', 'understrap-master' ); ?></h4>
							</div>
						</div>
					</div>
					*/ ?>
		...
		<div class="container mt-6 green" id="formacionmsc">
			...
			<div class="row space">
				...
				<div class="col-xl-5 offset-xl-1 col-lg-6 col-md-6">
					<h6 class="mb-xl-5 mb-4 mt-md-0 mt-5"><?php _e( 'Estructura: ', 'understrap-master' ); ?></h6>
					<ul class="list-unstyled">
						...
						<li class="mb-4">• <strong><?php _e( 'Instructora Certificada: ', 'understrap-master' ); ?></strong><?php _e( 'Coral Selfa, Psicóloga. Teacher Trained en Mindful Self-Compassion.', 'understrap-master' ); ?></li>
			...
			<div class="row mt-6">
				<div class="col-xl-5 col-md-6">
					...
					<ul class="list-unstyled">
						...
						<li class="mb-3">• <?php _e('Acompañamiento por una instructora certificada durante 2 meses.','understrap-master');?></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 green mt-5">
					...
					<p class="font-weight-bold mt-5"><?php _e( 'Síguenos de cerca para conocer nuestros próximos Retiros de Silencio.', 'understrap-master' ); ?></p>
					<a class="btn no-radius  big mt-4" href="<?php echo get_site_url();?>/contacto" title="<?php _e( 'Ir a Contacto', 'understrap-master' ); ?>"><?php _e( 'Me interesa', 'understrap-master' ); ?></a>
				</div>
			</div>
		</div>
