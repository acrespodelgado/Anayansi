		...
		<nav id="main-nav" class="navbar" aria-labelledby="main-nav-label">
			...
			<div class="contact-info text-right">
				<div class="d-none d-md-block">
					<a href="mailto:centro.anayansi@gmail.com"  title= "<?php _e( 'Contactar con Anayansi', 'understrap-master' ); ?>" >centro.anayansi@gmail.com</a>    
					<span class="bar">|</span>    
					<a href="tel:+34676251725" title="<?php _e( 'Llamar a Anayansi', 'understrap-master' ); ?>">+34 676 25 17 25</a>
				</div>
				<div class="d-block d-md-none">
					<a href="mailto:centro.anayansi@gmail.com"  title= "<?php _e( 'Contactar con Anayansi', 'understrap-master' ); ?>" ><span class="lnr lnr-envelope"></span></a>    
					<span class="bar">|</span>    
					<a href="tel:+34676251725" title="<?php _e( 'Llamar a Anayansi', 'understrap-master' ); ?>"><span class="lnr lnr-phone-handset"></span></a>
				</div>
			</div>
		</nav><!-- .navbar -->
