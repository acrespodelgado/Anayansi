			...
			<div class="container">
				<div class="row">
					<div class="col-lg-9 offset-lg-3 col-md-8 offset-md-4">
						<?php /* <h4 class="brown-line  bitter mb-md-5 mb-0"><?php _e( 'Equipo Docente IME:', 'understrap-master' ); ?></h4> */ ?>
						<h4 class="brown-line  bitter mb-md-5 mb-0"><?php _e( 'Directora de la Formación IME:', 'understrap-master' ); ?></h4>
					</div>
				</div>
					...
					<div class="item">				
						<div class="row">
							...
							<div class="col-lg-9 col-md-8">
								...
								<?php /* <p class="bitter "><?php _e( 'Directora Formación IME', 'understrap-master' ); ?></p> */ ?>
